...
: ${AMENT_CURRENT_PREFIX:="/media/flora/myros/new_re2_ws/install/nac"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nac/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nac/environment/path.sh"
